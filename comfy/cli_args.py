...
parser.add_argument("--enable-cors-header", type=str, default=None, metavar="ORIGIN", nargs='+', help="Enable CORS (Cross-Origin Resource Sharing) for specific origins, or all with '*'. You can provide multiple origins.")
